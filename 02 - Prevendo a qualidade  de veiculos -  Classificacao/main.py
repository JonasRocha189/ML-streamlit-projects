...
st.set_page_config(
  page_title="Classificacao de Veiculos",
  layout="wide"
)
...
st.title("Previsao da Qualidade de Veiculo")
st.write(f"Acurácia do modelo: {acuracia:.2f}")

input_features = [
  st.selectbox("Preço: ", carros['buying'].unique()),
  st.selectbox("Manutencao: ", carros['maint'].unique()),
  ...
  st.selectbox("Seguranca: ", carros['safety'].unique()),
]
